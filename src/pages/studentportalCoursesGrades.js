...
<div class="sidebar" dir="rtl" >
  <img src="img/finallogo.png" alt="منصة الارشاد الاكاديمى" width="50" height="40" class="d-inline-block align-text-top"> <span class="logo">جامعة الفيوم <br><span>الحاسبات والذكاء الاصطناعي </span></span>

  <hr>
  <diV class="showstudnameanddep">
  <h4 class="studname"> اهلا بك/<span> name</span> </h4>
  <h4 class="department">برنامج /<span> dep</span></h4>
</diV>
  <hr>
	<!-- <i class="fa fa-chevron-left menu-icon"></i> -->
	<ul class="sidenav">
<li><i class="fa fa-home"></i><a href="../studentportal.html" style="text-decoration: none;"> بيانات الشخصية</li>
      <li><i class="fa fa-clone"></i><a href="studentportalEmail.html"> ايميل الجامعة</a></li>
    ...
    <li>  <i class="fa fa-home"><a href="studentportalexpensess.html">المصروفات الدراسية </a></i></li>
       
            <li><i class="fa fa-calendar"></i><a href="studentportalsubschadule.html"> الجدول الدراسي</a></li>
            <li><i class="fa fa-file-text"></i><a href="studentportalsubjreg.html"> تسجيل المقررات الدراسية</a></li>
            <li><i class="fa fa-square"></i><a href="studentportalreports.html">استمارة التسجيل</a></li>
            <li><i class="fa fa-square-o"></i><a href="studentportalquestion.html">استبيان</a></li>
            <li><i class="fa fa-calendar"></i><a href="studentportalexamschadule.html"> جدول الامتحانات</a></li>
            <li><i class="fa fa-square"></i><a href="studentportaleltmas.html"> طلب اعاده رصد درجات(طلب التماس)</a></li>
            <li class="active"><i class="fa fa-square"></i><a href="studentportalCoursesGrades.html">تقديرات المقررات (بيان حاله دراسي)</a>
            <span class="span1"><i class="fa fa-angle-left"></i></span></li>
            <li><i class="fa fa-square"></i><a href="#">اعلان النتيجه</a></li>
            <li><i class="fa fa-square"></i><a href="#">الانذار الاكاديمي</a></li>
            <li><i class="fa fa-square"></i><a href="#"> طلب طباعة وثيقة</a></li>
		<!-- <p class="app">App Ans Pages</p> -->
		
		<li><i class="fa fa-user"></i><a href="#"> تغيير كلمة المرور</a></li>
    <li><i class="fa fa-file"></i><a href="../index.html">خروج</a></li>
